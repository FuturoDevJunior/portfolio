      ...
      <main className="pt-32 pb-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center" aria-labelledby="cta-heading">
          ...
          {/* Tech Stack Section */}
          <div className="mt-20 text-center" aria-labelledby="tech-stack-heading">
            <h2 id="tech-stack-heading" className="text-3xl font-bold mb-8">{t('techStack.title')}</h2>
            <div
      ...
      <footer className="py-12 bg-black border-t border-gray-800">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm">
            ...
            <div className="flex gap-6 mt-4 md:mt-0" role="navigation" aria-label={t('footer.legalLinks')}>
              <a
                href="/privacy"
                className="hover:text-purple-400 transition-colors"
