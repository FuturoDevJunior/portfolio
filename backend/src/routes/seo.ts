...
router.get('/metadata', (req: Request, res: Response) => {
    try {
        ...
        // Registrar evento
        logSeoEvent('metadata_request', page as string, { lang });
        ...
        const langKey = (lang as string).toLowerCase() || 'pt';
 ...
 *               type: object
 */
router.get('/schema-markup', (req: Request, res: Response) => {
    try {
        ...
        // Registrar evento
        logSeoEvent('schema_request', page as string, { type });
        ...
        if (page !== '/') {
            const pageName = (page as string).substring(1);
 ...
 *               type: object
 */
router.get('/analytics-code', (req: Request, res: Response) => {
    try {
        // Registrar evento
