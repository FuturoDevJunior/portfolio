...
const testAnalytics = async () => {
    try {
        ...
        const batchResponse = await fetch(`${baseUrl}/analytics/batch`, {
            method: 'POST',
            headers,
            body: JSON.stringify({
                events: [
        ...
        const utmResponse = await fetch(`${baseUrl}/marketing/track`, {
            method: 'POST',
            headers,
            body: JSON.stringify({
                sessionId,
        ...
        const conversionResponse = await fetch(`${baseUrl}/marketing/conversion`, {
            method: 'POST',
            headers,
            body: JSON.stringify({
                sessionId,
        ...
        const leadResponse = await fetch(`${baseUrl}/marketing/lead`, {
            method: 'POST',
            headers,
            body: JSON.stringify({
                sessionId,
